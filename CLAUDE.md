...
- `DowTheory_Trend.pine` - Dow Theory Trend indicator (Pine Script v6)
  ...
  - Exit สไตล์ V10.1: SL hit / TP hit เท่านั้น — วงกลมสีตามผล (เขียว=win, แดง=loss, เทา=breakeven, size.normal) + label แสดง win/loss พร้อมจำนวน R (เช่น +1.85R / -1.00R) + เส้นแนวนอนสั้น 6 แท่งที่ราคา exit + เส้นประ trade path จาก entry ถึง exit (สีตามผล, toggle ได้)
